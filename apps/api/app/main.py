...
from app.routers import (
    ...
    permissions, project_members, projects, prompts, rag_coverage, retrieval, retrieval_readiness, retrieval_runs, route_analysis, source_registry, source_registry_scan, synthetic_questions, trace_detail,
...
app.include_router(retrieval_readiness.router)
