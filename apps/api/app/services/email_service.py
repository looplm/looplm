...
def send_invitation_email(
    ...
    subject = f"You've been invited to join {project_name} on LoopLM"
    html = f"""\
<div style="font-family: -apple-system, sans-serif; max-width: 480px; margin: 0 auto;">
  <h2 style="color: #4f46e5;">LoopLM</h2>
  ...
  <p style="color: #6b7280; font-size: 13px;">
    ...
    plain = (
        f"{inviter_email} has invited you to join the project \"{project_name}\" on LoopLM.\n\n"
